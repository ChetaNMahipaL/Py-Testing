...
students = [
    ...
    [{'name': 'John Kirkman', 'scores': [95, 85, 94]},
    {'name': 'Emily Rhodes', 'scores': [80, 89, 100]},
    {'name': 'Aaron Shore', 'scores': [85, 88, 98]},
    {'name': 'Ray Atwood', 'scores': [74, 89, 90]},
    {'name': 'Penny Wells', 'scores': [79, 75, 82]},
    {'name': 'Mark Richmond', 'scores': [90, 65, 82]},
    {'name': 'Seth Wright', 'scores': [94, 89, 91]}],
    ...
    [{'name': 'John Kirkman', 'scores': [-95, 85, 94]},
    {'name': 'Emily Rhodes', 'scores': [80, -87, 100]},
    {'name': 'Aaron Shore', 'scores': [85, -88, 98]},
    {'name': 'Ray Atwood', 'scores': [74, 89, -90]},
    {'name': 'Penny Wells', 'scores': [79, 75, 82]},
    {'name': 'Mark Richmond', 'scores': [90, 65, 82]},
    ...
    [{'name': 'John Kirkman', 'scores': [95, 85, 94]},
    {'name': 'Emily Rhodes', 'scores': [80, 87, 110]},
    {'name': 'Aaron Shore', 'scores': [85, 88, 98]},
    {'name': 'Ray Atwood', 'scores': [74, 89, 90]},
    {'name': 'Penny Wells', 'scores': [79, 75, 82]},
    {'name': 'Mark Richmond', 'scores': [90, 65, 82]},
    {'name': 'Seth Wright', 'scores': [94, 89, 0]}],
